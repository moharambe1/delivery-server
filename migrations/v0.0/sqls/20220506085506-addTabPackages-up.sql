...
CREATE TYPE StatePackageEnum AS ENUM('RECEIVING','RECEIVED','STORED','DELIVERING','DELEVERED','RETURNING','RETURN','PAYED' ,'DONE');
CREATE TYPE StateMoneyEnum AS ENUM('MANAGER','DELIVER','RECIVER','CLIENT','PAYED','RETURNED');
